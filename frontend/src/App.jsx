...
import { LayoutDashboard, Truck, User, Users, LogOut, Menu, X, History as HistoryIcon, Activity, Building2, Files } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <header style={{ backgroundColor: 'var(--card-bg)', borderBottom: '1px solid var(--card-border)', transition: 'background-color 0.3s', position: 'sticky', top: 0, zIndex: 1000 }}>
      <nav className="navbar-container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', maxWidth: '1550px', margin: '0 auto', padding: '0 24px' }}>
